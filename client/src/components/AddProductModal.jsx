...
const ProductModal = ({ handleAddUpdate, handleChange, setShowAdd,setAddProduct, addProduct, showAdd, showEdit, setShowEdit }) => {
  ...
  return (
    <div className=" lg:w-8/12 sm:w-12/12 py-12 px-12 border border-gray-300 bg-white rounded absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ">
